...
class DefaultTasksRepository(
    ...
    override suspend fun getTasks(forceUpdate: Boolean): kotlin.Result<List<Task>> {
        if (forceUpdate) {
            try {
                updateTasksFromRemoteDataSource()
            } catch (ex: Exception) {
                return kotlin.Result.Error(ex)
            }
        }
    ...
    override fun getTaskStream(taskId: String): Flow<kotlin.Result<Task>> {
     ...
     */
    override suspend fun getTask(taskId: String, forceUpdate: Boolean): kotlin.Result<Task> {
        if (forceUpdate) {
            updateTaskFromRemoteDataSource(taskId)
        }
    ...
    private suspend fun getTaskWithId(id: String): kotlin.Result<Task> {
